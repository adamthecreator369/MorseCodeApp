...
public class ChatLayout extends Layout {
	...
	protected void componentSettings() {
		...
		hostRadio.setBounds(R.dimens.HOST_RADIO_X, R.dimens.HOST_RADIO_Y, R.dimens.BTN_WIDTH, R.dimens.BTN_HEIGHT);
		guestRadio.setBounds(R.dimens.GUEST_RADIO_X, R.dimens.CHAT_BTN_Y - 15, R.dimens.BTN_WIDTH, R.dimens.BTN_HEIGHT);
